function phi = doa_gcc2303Phimedio(alg,x1,x2,x3,x4,dx,N,Fs,v,t90)
...
Mphi = zeros(Ndata-1,1); %arithmetic mean between the four vectors
...
[s_spec,f_spec,t_spec] = spectrogram(x1_resample,hamming(1024),512,1024,32000,'yaxis');
for i = 1:length(t_spec)
max_s_spec(i) = max(s_spec(:,i));
end
[max_s_specmax,it90max] = max(max_s_spec(620:770))
it90 = 620 + it90max
t90 = it90*0.016
%figure
%plot(t_spec,max_s_spec)
