...
for j = 1:3
    ...
    %phi = doa_gcc2303Phimedio(2,Yxt(:,1),Yxt(:,2),Yxt(:,3),Yxt(:,4),0.2,N,Fs,v,t90);
    %pause
    
    phi = doa_gcc2003TwoSources(2,Yxt(:,i1),Yxt(:,i2),0.2,N,Fs,v,t90);
    pause
    
    %pmusic(Yxt(:,i1),4);
    %pause

    %phi = doa_aevd0603(Yxt(:,i1),Yxt(:,i2),d,512,2048,0.3,Fs);
    %pause

    %phi=doa_itd0603(Yxt(:,i1),Yxt(:,i2),d,Nitd,Fs);
    %pause

    %phi = doa_fastlms0603(Yxt(:,i1),Yxt(:,i2),d,512,2048,0.25,Fs);
    %pause
