function phi = doa_gccfullBand(alg,x1,x2,dx,N,Fs,v,sentido,qtdeCarros,mic_ver)
...
[ind2,phi2] = TheoPhi_and_Espectrogram_antigo(v,sentido,qtdeCarros,x1,Fs,mic_ver);
